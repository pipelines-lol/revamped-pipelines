  ...
  return (
    <div className="flex">
      ...
      <div className="ml-4">
        ...
        <div className="text-pipelines-gray-100/50 mr-8 mt-2 text-sm md:text-lg">
          {props.children}
        </div>
      </div>
    </div>
...
const Offerings: React.FC = () => {
  ...
  const staggerContainer: MotionProps["variants"] = {
    hidden: { opacity: 0 },
    show: {
      opacity: 1,
      transition: {
  ...
  const parent: MotionProps["variants"] = {
    hidden: {
      opacity: 0,
      y: 50,
    },
  ...
  return (
    <div className="border-pipeline-blue-200 mb-12 flex h-full w-full flex-col  items-center justify-center border-b-[0.5px] border-t-[0.5px]">
          ...
          <div className="mx-auto max-w-7xl px-4 md:px-8">
            ...
            >
              <div className="text-center">
                <h2 className="text-uppercase text-pipeline-blue-200 mx-auto mt-10 font-semibold tracking-wide md:max-w-3xl md:text-center">
                  What We Offer
                </h2>
                <p className="xs:max-w-3xl text-pipelines-gray-100 mx-auto my-8 text-2xl font-normal tracking-tight sm:px-12 sm:text-4xl md:text-center lg:text-6xl">
                  Take a deeper dive into{" "}
                  <span className="from-pipeline-blue-200 to-pipeline-blue-200 bg-gradient-to-tl bg-clip-text text-transparent">
                    LinkedIn.
                  </span>
                </p>
                <p className="text-md text-pipelines-gray-100/80 mx-auto px-8 font-normal tracking-normal sm:max-w-lg md:max-w-2xl md:text-center md:text-xl">
                  No more of the &#34;outside your network&#34; blocker. No more
                  algorithms. No more ads. No more feeling like a stalker.
                </p>
              </div>
                ...
                >
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    {offeringsData.map((offering, idx) => (
                      ...
                      >
                        <Offering title={offering.title} icon={offering.icon}>
              ...
              <p className="text-pipelines-gray-100/80 mx-auto mb-12 mt-12 p-4 text-center text-xl font-normal tracking-normal md:max-w-3xl">
                Pipelines focuses on the core of what LinkedIn was meant to be:
                a place to share your career journey with others.
              </p>
            </motion.div>
          </div>
        </div>
